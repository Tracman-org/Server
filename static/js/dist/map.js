...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_load_google_maps_api__ = __webpack_require__(52);
...
function toggleMaps(loc) {
	if (loc.lat===0&&loc.lon===0) {
		__WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#map').hide();
		__WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#pano').hide();
		__WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#notset').show();
	}
	else {
		__WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#map').show();
		__WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#pano').show();
		__WEBPACK_IMPORTED_MODULE_1_jquery___default.a('#notset').hide();
	}
}
